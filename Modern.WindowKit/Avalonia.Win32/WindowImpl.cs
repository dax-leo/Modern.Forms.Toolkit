...
//using Modern.WindowKit.Win32.DirectX;
...
namespace Modern.WindowKit.Win32
        ...
        ITopLevelImplWithStorageProvider
    {
        ...
        private void CreateWindow()
        {
            ...
            const ClassStyles windowClassStyle = ClassStyles.CS_OWNDC | ClassStyles.CS_HREDRAW | ClassStyles.CS_VREDRAW;// | ClassStyles.CS_DROPSHADOW;
        ...
        {
            //Debug.WriteLine("WindowsImpl: " + state);
            _shown = true;
            ...
            //Debug.WriteLine(newWindowProperties);
            UpdateWindowProperties(newWindowProperties);
