...
namespace Modern.Forms
{
    ...
    public class SplitContainer : Control
    {
        ...
        public SplitContainer ()
        {
            ...
            Panel2 = Controls.Add (new Control { Dock = DockStyle.Fill });
            splitter = Controls.Add (new Splitter { SplitterWidth = 5 });
            Panel1 = Controls.Add (new Control { Dock = DockStyle.Left });
        ...
        //    if (oldParent != null) Parent.SizeChanged -= Parent_SizeChanged;
        //    oldParent = Parent;
        ...
        /// </summary>
        public Control Panel2 { get; private set; }
