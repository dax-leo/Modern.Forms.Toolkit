...
namespace Modern.Forms
{
    ...
    public partial class Control : Component, ILayoutable, IArrangedElement, IDisposable
    {
        ...
        public void Invalidate (Rectangle rectangle)
        {
            ...
            SetAllChildsDirty (this);// propagate dirty state to all childs
        ...
        private void SetAllChildsDirty (Control c)
        {
            c.SetState (States.IsDirty, true);
            foreach (var ctrl in c.Controls.GetAllControls ()) {
                ctrl.SetAllChildsDirty (ctrl);
            }
        }
