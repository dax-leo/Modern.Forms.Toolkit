...
namespace Modern.Forms.Renderers
{
    ...
    public class ScrollBarRenderer : Renderer<ScrollBar>
    {
        ...
        protected override void Render (ScrollBar control, PaintEventArgs e)
        {
            ...
            // Total Scroll Area Background
            var tot_area = GetTotalTrackBounds (control);
            e.Canvas.FillRectangle (tot_area, Theme.ScrollBack);
            
            // Top Arrow
            e.Canvas.FillRectangle (top_arrow_area, Theme.ScrollBack);
            e.Canvas.DrawRectangle (top_arrow_area, Theme.ScrollArrowBorder);
            ControlPaint.DrawArrowGlyph (e, top_arrow_area, Theme.ScrollBorder, GetDecrementArrowDirection (control));

            // Bottom Arrow
            e.Canvas.FillRectangle (bottom_arrow_area, Theme.ScrollBack);
            e.Canvas.DrawRectangle (bottom_arrow_area, Theme.ScrollArrowBorder);
            ControlPaint.DrawArrowGlyph (e, bottom_arrow_area, Theme.ScrollBorder, GetIncrementArrowDirection (control));
            ...
            if (thumb_bounds.Width > 0 && thumb_bounds.Height > 0) {
                e.Canvas.FillRectangle (thumb_bounds, Theme.ScrollHandle);
                e.Canvas.DrawRectangle (thumb_bounds, Theme.ScrollBorder);
            }
        }
