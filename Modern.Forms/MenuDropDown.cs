    ...
    public class MenuDropDown : MenuBase
    {
        ...
        public new static ControlStyle DefaultStyle = new ControlStyle (Control.DefaultStyle,
         (style) => {
             ...
             style.Border.Color = SKColor.Empty;
         });
        ...
        protected override void LayoutItems ()
        {
            ...
            height = sizes.Select (s => s.Height).Sum () + 4;

            var client_rect = new Rectangle (0, 0, width - 2, height - 2);
        ...
        internal static Size ScaleSize (Size startSize, float x, float y)
        {
            ...
            size.Width = (int)Math.Round ((float)size.Width * x, MidpointRounding.ToZero);
            size.Height = (int)Math.Round ((float)size.Height * y, MidpointRounding.ToZero);
