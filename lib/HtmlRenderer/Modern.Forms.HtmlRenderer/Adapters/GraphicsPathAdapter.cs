...
namespace TheArtOfDev.HtmlRenderer.Avalonia.Adapters
{
    ...
    internal sealed class GraphicsPathAdapter : RGraphicsPath
    {
        ...
        public override void Start(double x, double y)
        {
            ...
            _graphicsPath.MoveTo(new SKPoint((float)x, (float)y));
        }

        public override void LineTo(double x, double y)
        {    
            _graphicsPath.LineTo(new SKPoint((float)x, (float)y));
        ...
        {            
            ...
            SKRect r = new SKRect();
            r.Size = new SKSize((float)size * 2, (float)size * 2);
            r.Location = new SKPoint(left, top);

            _graphicsPath.ArcTo(r, GetStartAngle(corner), 90, false);
        ...
        /// </summary>
        public SKPath GetClosedGeometry()
        {
            _graphicsPath.Close();            
