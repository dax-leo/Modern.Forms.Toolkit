        ...
        public string FontSize
        {
            ...
            set
            {
                ...
                if (length != null)
                {
                    ...
                    {
                        //added scalling 
                        computedValue = len.ConvertEmToPoints((GetParent().ActualFont.Size / ModernFormsAdapter.Instance.ScalingFactor)).ToString();
                        //computedValue = len.ConvertEmToPoints(GetParent().ActualFont.Size).ToString();
                    }
                    else
                    {                        
                        computedValue = len.ToString();
                        //computedValue = (len.Number * ModernFormsAdapter.Instance.ScalingFactor).ToString();
                    }
