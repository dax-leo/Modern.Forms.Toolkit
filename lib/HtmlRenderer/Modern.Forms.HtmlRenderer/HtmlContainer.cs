...
namespace TheArtOfDev.HtmlRenderer.Avalonia
{
    ...
    public sealed class HtmlContainer : IDisposable
    {
        ...
        {            
            _htmlContainerInt = new HtmlContainerInt(ModernFormsAdapter.Instance);
        ...
        {
            get { return Utils.ConvertInt(_htmlContainerInt.ScrollOffset); }
            set { _htmlContainerInt.ScrollOffset = Utils.ConvertInt(value); }
        }
        ...
        {
            get { return Utils.ConvertInt(_htmlContainerInt.Location); }
            set { _htmlContainerInt.Location = Utils.ConvertInt(value); }
        }
        ...
        {
            return _htmlContainerInt.GetAttributeAt(Utils.ConvertInt(location), attribute);
        }
        ...
        public void PerformPaint(SKCanvas g, RectangleF clip)
        {
        ...
        public void HandleLeftMouseDown(Control parent, MouseEventArgs e)
        {
            ArgChecker.AssertArgNotNull(parent, "parent");
            ArgChecker.AssertArgNotNull(e, "e");

            //var loc = e.Location;
            //var x = parent.FindForm().PointToScreen(e.Location);
            //loc.Offset(parent.FindForm().PointToScreen(x));
            //var loco = parent.PointToScreen(e.Location);

            _htmlContainerInt.HandleMouseDown(new ControlAdapter(parent), Utils.ConvertInt(e.Location));
        }
        ...
        /// <param name="parent">the control hosting the html to invalidate</param>
        /// <param name="e">the mouse event args</param>
        public void HandleLeftMouseUp(Control parent, MouseEventArgs e)
        {
            ArgChecker.AssertArgNotNull(parent, "parent");
            ArgChecker.AssertArgNotNull(e, "e");

            var mouseEvent = new RMouseEvent(true);
            _htmlContainerInt.HandleMouseUp(new ControlAdapter(parent), Utils.ConvertInt(e.Location), mouseEvent);
        }
        ...
        public void HandleMouseDoubleClick(Control parent, MouseEventArgs e)
        {
            ...
            _htmlContainerInt.HandleMouseDoubleClick(new ControlAdapter(parent), Utils.ConvertInt(e.Location));
        }
        ...
        public void HandleMouseMove(Control parent, Point mousePos)
        {
            ...
            _htmlContainerInt.HandleMouseMove(new ControlAdapter(parent), Utils.ConvertInt(mousePos));
        }
