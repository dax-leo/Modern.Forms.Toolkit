...
namespace TheArtOfDev.HtmlRenderer.Avalonia
{
    ...
    public static class HtmlRender
    {
        ...
        public static void AddFontFamily(FontFamily fontFamily)
        {
            ...
            ModernFormsAdapter.Instance.AddFontFamily(new FontFamilyAdapter(fontFamily));
        }
        ...
        {
            return CssData.Parse(ModernFormsAdapter.Instance, stylesheet, combineWithDefault);
        }
        ...
        //public static Size Render(SKCanvas g, string html, double left = 0, double top = 0, double maxWidth = 0, CssData cssData = null,
        //    EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad = null, EventHandler<HtmlImageLoadEventArgs> imageLoad = null)
        //{
        ...
        /// <param name="imageLoad">optional: can be used to overwrite image resolution logic</param>
        /// <returns>the actual size of the rendered html</returns>
        //public static Size Render(SKCanvas g, string html, Point location, Size maxSize, CssData cssData = null,
        //    EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad = null, EventHandler<HtmlImageLoadEventArgs> imageLoad = null)
        //{
        //    ArgChecker.AssertArgNotNull(g, "g");
        ...
        public static SKBitmap RenderToImageGdiPlus(string html, SKSize size, CssData cssData = null,
            EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad = null, EventHandler<HtmlImageLoadEventArgs> imageLoad = null)
        {
            ...
            using (var g = new SKCanvas(image))
            {
                ...
                RenderHtml(g, html, Point.Empty, size, cssData, stylesheetLoad, imageLoad);
            }
        ...
        private static SKSize MeasureHtmlByRestrictions(HtmlContainer htmlContainer, SKSize minSize, SKSize maxSize)
        {
        ...
        /// <param name="imageLoad">optional: can be used to overwrite image resolution logic</param>
        /// <returns>the actual size of the rendered html</returns>
        //private static Size RenderClip(SKCanvas g, string html, Point location, Size maxSize, CssData cssData, EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad, EventHandler<HtmlImageLoadEventArgs> imageLoad)
        //{
        ...
        /// <param name="imageLoad">optional: can be used to overwrite image resolution logic</param>
        /// <returns>the actual size of the rendered html</returns>
        private static SKSize RenderHtml(SKCanvas g, string html, Point location, SKSize maxSize, CssData cssData, EventHandler<HtmlStylesheetLoadEventArgs> stylesheetLoad, EventHandler<HtmlImageLoadEventArgs> imageLoad)
        {
            SKSize actualSize = default;
            ...
            if (!string.IsNullOrEmpty(html))
            {
                using (var container = new HtmlContainer())
                {
                    ...
                    container.SetHtml(html, cssData);
                    container.PerformLayout();
                    container.PerformPaint(g, new RectangleF(0, 0, float.MaxValue, float.MaxValue));
